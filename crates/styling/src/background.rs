...
impl Style<BackgroundBaseState<AttributeGetter<simple_props::BackgroundOrigin>>> {
...
impl Style<BackgroundBaseState<AttributeGetter<simple_props::BackgroundClip>>> {
    pub fn padding_box(self) -> Style<BackgroundBaseState<()>> {
...
impl Style<BackgroundBaseState<AttributeGetter<simple_props::BackgroundBlendMode>>> {
...
impl Style<BackgroundBaseState<AttributeGetter<simple_props::BackgroundAttachment>>> {
...
impl Style<BackgroundBaseState<AttributeGetter<simple_props::BackgroundRepeat>>> {
