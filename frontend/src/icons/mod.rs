...
pub mod leptos_version {
    use leptos::prelude::*;
    pub const RESPONSIVE_ICON_LG: &str = "h-5 w-5 lg:h-6 lg:w-6 2xl:h-7 2xl:w-7";
    pub const RESPONSIVE_ICON: &str = "h-4 w-4 lg:h-5 lg:w-5 2xl:h-6 2xl:w-6";

    const STROKE: &str = "currentColor";
    const STROKE_WIDTH: &str = "1.5";
    const BOX: &str = "0 0 24 24";
    const FILL: &str = "none";
    const LCAP: &str = "round";
    const LJOIN: &str = "round";

    #[component]
    pub fn Svg(class: String, children: Children) -> impl IntoView {
        view! {
            <svg
                class=class
                viewBox=BOX
    ...
    #[component]
    pub fn ChooseViewIcon(
        #[prop(default=RESPONSIVE_ICON.to_string())] class: String,
    ) -> impl IntoView {
        view! {
            <Svg class=class>
    ...
    #[component]
    pub fn PlusIcon(#[prop(default=RESPONSIVE_ICON.to_string())] class: String) -> impl IntoView {
        view! {
            <Svg class=class>
    ...
    #[component]
    pub fn MinusIcon(#[prop(default=RESPONSIVE_ICON.to_string())] class: String) -> impl IntoView {
        view! {
            <Svg class=class>
                <line x1="5" x2="19" y1="12" y2="12"/>
            </Svg>
    ...
    #[component]
    pub fn WrenchIcon(#[prop(default=RESPONSIVE_ICON.to_string())] class: String) -> impl IntoView {
        view! {
            <Svg class=class>
    ...
    #[component]
    pub fn AlbumIcon(#[prop(default=RESPONSIVE_ICON.to_string())] class: String) -> impl IntoView {
        view! {
            <Svg class=class>
    ...
    #[component]
    pub fn FolderIcon(#[prop(default=RESPONSIVE_ICON.to_string())] class: String) -> impl IntoView {
        view! {
            <Svg class=class>
    ...
    #[component]
    pub fn SaveIcon(#[prop(default=RESPONSIVE_ICON.to_string())] class: String) -> impl IntoView {
        view! {
            <Svg class=class>
    ...
    #[component]
    pub fn UndoIcon(#[prop(default=RESPONSIVE_ICON.to_string())] class: String) -> impl IntoView {
        view! {
            <Svg class=class>
    ...
    #[component]
    pub fn RedoIcon(#[prop(default=RESPONSIVE_ICON.to_string())] class: String) -> impl IntoView {
        view! {
            <Svg class={class}>
    ...
    #[component]
    pub fn BoldIcon(#[prop(default=RESPONSIVE_ICON.to_string())] class: String) -> impl IntoView {
        view! {
            <Svg class=class>
    ...
    #[component]
    pub fn QuoteIcon(#[prop(default=RESPONSIVE_ICON.to_string())] class: String) -> impl IntoView {
        view! {
            <Svg class={class}>
    ...
    #[component]
    pub fn LinkIcon(#[prop(default=RESPONSIVE_ICON.to_string())] class: String) -> impl IntoView {
        view! {
            <Svg class=class>
    ...
    #[component]
    pub fn FormatIcon(#[prop(default=RESPONSIVE_ICON.to_string())] class: String) -> impl IntoView {
        view! {
            <Svg class=class>
    ...
    #[component]
    pub fn ImageIcon(#[prop(default=RESPONSIVE_ICON.to_string())] class: String) -> impl IntoView {
        view! {
            <Svg class=class>
    ...
    #[component]
    pub fn TableIcon(#[prop(default=RESPONSIVE_ICON.to_string())] class: String) -> impl IntoView {
        view! {
            <Svg class=class>
    ...
    #[component]
    pub fn CloseIcon(#[prop(default=RESPONSIVE_ICON.to_string())] class: String) -> impl IntoView {
        view! {
            <Svg class=class>
                <path d="M18 6 6 18"/>
                <path d="m6 6 12 12"/>
    ...
    #[component]
    pub fn BitcoinQr() -> impl IntoView {
        // (https://fukuchi.org/works/qrencode/index.html)
